...
<h5>This page will provide an on-demand Daily Commencement Report.</h5>

  <BR> <font color="red"> Note: Saving Excel file will take some time to run. Please be patient Click Button only once.</font>
