...
/*************************************************************************************************************************************************************/
public String  buildCells( JspWriter out, JSONArray jsonArr  ) throws IOException {
	String cells = "";
    		...
    		while (iterator.hasNext()) {
				...
				if (obj instanceof JSONObject) {
					...
					for (String key : keys) {
						...
						rowItem = ((JSONObject) obj).get(key).toString();
						if (key.equals("url")) {
							cells += "<td class=\"odd\"> <a href=\"" + rowItem + "\"   target=\"_blank\"      >" + rowItem +  "</a></td>";
						} else {
							cells += "<td class=\"odd\">" + rowItem + "</td>";
						}
					}
					cells += "</tr >";
...
<%
		...
		String cells =  buildCells(out, jsonArr); // build data cells from file
		out.println(cells);
