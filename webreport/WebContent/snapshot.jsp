...
<% 
  	String title =  "Olympus FIS Snapshot Report"; 
...
public String TableHeader(){
	...
	thead += "<th>Start Date</th>";
	thead += "<th>Orig Term Date</th>";
	thead += "<th>FSG Territory</th>";
	thead += "<th class=\"c\">MSG Rep</th>";
	thead += "<th class=\"c\">MSG Manager</th>";
	thead += "<th>Monthly Minimum</th>";
	thead += "<th>Total Procedure</th>";
	thead += "<th>Procs to Date</th>";
	thead += "<th>CPP Rate</th>";
	thead += "<th>Service Rate</th>";
	thead += "<th>Other Rates</th>";
	thead += "<th>Mthly Payment</th>";
	thead += "<th>EOT Option</th>";
