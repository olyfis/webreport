    ...
    while (it.hasNext()) {
	      ...
	      // System.out.println("******  &&&&  ********** Key:" +  key + "---- errValue:" + errs.get(key.toString()));
	        ...
	        if ((   errs.get(key) != null )  &&   errs.get(key).booleanValue() == true  )    {	
		         //System.out.println("*** IF %%%*** Key:" + key + " ERRValue: " + errs.get(key.toString()));
		       
		         
		        colorErr = "#F55A48";
	      	} else {
	      		 //System.out.println("***ELSE %%%*** Key:" + key + " ERRValue: " + errs.get(key.toString()));
	       
	      		colorErr = "#e3e9f2";
	      		 if ((j <= 33 && j >= 30) || j== 8) {
	      			 
	      				
	      		//if (j == 33 || j== 8 || j== 30 || j== 32  ) {
	        			colorErr = "#e5dd80";
	      		}
		...
		for (int k = 0; k < list.size(); k++) {
			...
			for (int x = 0; x < token_list.length; x++) {
				 ...
				 */
				  			...
				  			/*************************************************************************************************************************************************/
					for (String s : list3) {
						out.println("<h5> <b><font color=\"red\" >" + s + "	 </b></h5>");
					}

					for (String e2 : err2) {
						out.println("<h5><b><font color=\"red\" >" + e2 + "	 </b></h5>");
					}
					for (String e3 : err3) {
						out.println("<h5> <b><font color=\"red\" >" + e3 + "	 </b></h5>");
					}
