...
<title>Olympus FIS Infolease Asset Validation Application</title>
...
<div style="padding-left:20px">
  <h3>Olympus FIS Infolease Asset Validation Application</h3>
</div>

<BR>

<h5>This page will provide functionality to validate certain Asset fields.</h5>
...
<BR>
	...
	<form name="actionform" method="get" action="assetchk">
  ...
  <tr>
    ...
    <!--  
        ...
        <select name="actiontype" onchange='ajaxFunction()' >
		  ...
		  <option value="15">Validate Assets</option>
