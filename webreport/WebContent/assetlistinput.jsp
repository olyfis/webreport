...
<title>Olympus FIS Asset List Application</title>
...
<div style="padding-left:20px">
  <h3>Olympus FIS Asset List Application</h3>
</div>
...
<BR>
	...
	<form name="actionform" method="get" action="assetlist" name=id'>

<BR>


<table class="a" width="40%"  border="1" cellpadding="1" cellspacing="1">
<tr> <th class="theader"> Olympus FIS Asset List Applicationn</th> </tr>
  <tr>
    <td class="table_cell">
    <!--  Inner Table -->
