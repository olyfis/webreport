...
<script type="text/javascript" src="includes/js/chartjs/getappdataSBO.js"></script>
 ...
 <script >
 	var chartview = function() {
		...
		//alert("****** in charview"  );
		//window.open("http://cvyhj3a27:8181/webreport/displaydashchart.jsp");
 		window.open("http://localhost:8181/webreport/displaydashchart.jsp");
	}
</script>
</head>
<body>
...
<form enctype="multipart/form-data" method="post" >	   
 <input type="button" onclick="chartview()" value="Visualize Data"/> 
</form>
