...
public class ManageLeads {
	...
	static final String USERNAME = "fis_integration@olympus.com.fis";
	static final String PASSWORD = "Olympus123!!";
	static final String LOGINURL = "https://test.salesforce.com";
	static final String GRANTSERVICE = "/services/oauth2/token?grant_type=password";
	static final String CLIENTID = "3MVG9oZtFCVWuSwMVR6sRPcGwZToO7wE.zHg4JJjkAPbkcVXKtIrWbLH4rSgn4V3u4wwsc4JzGzJEKE33Rect";
	static final String CLIENTSECRET = "2784740809253650506";
 ...
 // Query Leads using REST HttpGet
    public static void queryLeads() {
        ...
        try {
           ...
           // String uri = baseUri + "/query?q=Select+Id+,+FirstName+,+LastName+,+Company+,+email+,+Phone+From+Lead+Limit+5";
 ...
 // Create Leads using REST HttpPost
    public static void createLeads() {
        ...
        try {
            ...
            lead.put("FirstName", "Fred");
            lead.put("LastName", "Zeppelin");
            lead.put("Company", "Olympus.com");
            lead.put("PostalCode", "18015");
            lead.put("Email", "Fred@fred.com");
