package com.olympus.contract.validation;
	...
	public class ValidateRangeContractChk {
	...
	*/
		...
		public static ArrayList<String> purchOptChk(ArrayList<String> strArr) throws IOException, SQLException {
			...
			for (String str : strArr) { // iterating ArrayList
				...
				System.out.println("*^^^^*** ValRangeContractChk -- PO1=" + po1 + "-- poDB=" + poDB + "--");
				if(poDB.equals("20")) {
					continue;
				}
				if (!po1.equals(poDB)) {
		...
		public static  String doValidation(Connection conn, String id, String bookDate) throws IOException, SQLException {
			...
			if (conn != null) {
				...
				errStr = ValidateRangeAssetChk.runChecks(id, bookDate, strArr);
			}
